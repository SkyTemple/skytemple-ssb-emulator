...
#[derive(Debug)]
/// Python callable with signature def _(script_runtime_struct_mem: bytes, script_target_slot_id: u32, current_opcode: u32).
pub struct DebugRegisterScriptDebugStartCallback(pub PyObject);

#[derive(Debug)]
/// Python callable with signature def _().
pub struct DebugRegisterScriptDebugEndCallback(pub PyObject);
